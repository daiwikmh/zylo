      ...
      <div className="dashboard-content">
        <div className="dashboard-main">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem', marginBottom: '1rem' }}>
            {/* Total Assets Card */}
            <div className="yield-card" style={{ background: '#070709', color: 'white', border: '1px solid rgba(225, 196, 233, 0.2)' }}>
              <div className="yield-card-header">
                <div className="yield-icon-wrapper" style={{ background: 'linear-gradient(135deg, #E1C4E9 0%, #C9A8D4 100%)' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#070709" strokeWidth="2.5">
                    <rect x="2" y="7" width="20" height="14" rx="2" ry="2" />
                    <path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" />
                  </svg>
                </div>
                <span className="yield-badge" style={{ background: 'rgba(225, 196, 233, 0.2)', color: '#E1C4E9' }}>
                  Live
                </span>
              </div>
          ...
          <div className="yield-graph-card" style={{ background: '#070709', color: 'white', border: '1px solid rgba(225, 196, 233, 0.2)' }}>
            <div className="yield-graph-header" style={{ borderBottom: '1px solid rgba(225, 196, 233, 0.1)' }}>
              <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <div style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#E1C4E9' }}></div>
                ...
                <select
                  style={{
                    ...
                    borderRadius: '0.5rem',
                    border: '1px solid rgba(225, 196, 233, 0.2)',
              ...
              <svg width="100%" height="280" style={{ overflow: 'visible' }}>
                <defs>
                  <linearGradient id="yieldGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" style={{ stopColor: '#E1C4E9', stopOpacity: 0.3 }} />
                    <stop offset="100%" style={{ stopColor: '#E1C4E9', stopOpacity: 0.05 }} />
                  </linearGradient>
                </defs>
            ...
            {/* Stats Row */}
            <div className="yield-stats-row" style={{ borderTop: '1px solid rgba(225, 196, 233, 0.1)' }}>
